  ...
  return (
    <div className='h-[100%]'>
        <div className='flex justify-evenly mt-5' >
            ...
            <Link href='/accounts/signup' ><h2 className='pl-3 signup-btn ml-3'>Signup for free  </h2></Link>
            </div>
        ...
        {/* <div className='div-center'>
            <h2 className='text-5xl font-semibold'>Build your best ideas together</h2>
...
<h2 className='block pl-3 signup-btn mt-5'><Link href='/accounts/signup' className='block' >Get Started </Link> </h2>
